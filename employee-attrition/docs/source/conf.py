...
# employee_attrition documentation build
...
from employee_attrition import __version__ as release
...
htmlhelp_basename = "employee_attritiondoc"
...
texinfo_documents = [
    (
        ...
        author,
        "employee_attrition",
        "Project employee_attrition codebase.",
        "Nearest-Neighbour",
    )
]
